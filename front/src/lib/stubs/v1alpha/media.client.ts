...
// @generated from protobuf file "v1alpha/media.proto" (package "media.v1alpha", syntax proto3)
// tslint:disable
...
export interface IMediaServiceClient {
     ...
     *
     * @generated from protobuf rpc: GetMedia(media.v1alpha.MediaRequest) returns (media.v1alpha.MediaResponse);
     */
    getMedia(input: MediaRequest, options?: RpcOptions): UnaryCall<MediaRequest, MediaResponse>;
    /**
     * ListMedia retrieves all media files.
     *
     * @generated from protobuf rpc: ListMedia(media.v1alpha.MediaRequest) returns (stream media.v1alpha.MediaResponse);
     */
     ...
     *
     * @generated from protobuf rpc: DeleteMedia(media.v1alpha.MediaRequest) returns (media.v1alpha.MediaResponse);
     */
